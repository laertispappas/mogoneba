...
public class NavDrawer {
    ...
    public NavDrawer(BaseActivity activity){
        ...
        if (drawerLayout == null || navDrawerView == null) {
            throw new RuntimeException("Must have views with ids drawer_layout and nav_drawer");
        }

        Toolbar toolbar = activity.getToolbar();
        toolbar.setNavigationIcon(R.drawable.abc_ic_menu_moreoverflow_mtrl_alpha);
    ...
    public static class BasicNavDrawerItem extends NavDrawerItem implements View.OnClickListener {
        ...
        public void inflate(LayoutInflater inflater, ViewGroup navDrawerView) {
            ...
            if (container == null)
                throw new RuntimeException("Nav drawer item " + text + " could not be attached ti ViewGroup. View not found");
